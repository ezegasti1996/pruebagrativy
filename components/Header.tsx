        ...
        <div className="flex items-center gap-3 cursor-pointer group select-none">
          ...
          <div className="flex flex-col justify-center">
            <div className="flex items-baseline gap-[2px]">
              <span className="text-xl font-black italic tracking-tighter text-white font-heading leading-none drop-shadow-md">FBA</span>
              <span className="text-xl font-black italic tracking-tighter text-[#FF9900] font-heading leading-none drop-shadow-md">ACADEMY</span>
            </div>
