    ...
    <section className="py-24 bg-bg-dark border-y border-white/5 relative z-10 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-20 animate-fade-in-up">
          ...
          <p className="text-gray-300 font-medium text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Sin filtros. Sin edición. <span className="text-white font-bold border-b border-amazon/50">Dinero real en cuentas de estudiantes reales.</span> Así es como se ven las primeras semanas de nuestros alumnos.
          </p>
        </div>
